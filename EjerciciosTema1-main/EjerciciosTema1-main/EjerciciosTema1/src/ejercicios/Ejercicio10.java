...
public class Ejercicio10 {
	...
	public static void main(String[] args) {
		...
		System.out.print("Deme la longitud del lanzamiento en metros si usa decimales sepárelo con punto: ");
		longitud = key.nextDouble();
		//Realizamos la conversion de tipos a centímetros multiplicando por 100.
		longitud = longitud*100;
		//Imprimimos el resultado por pantalla haciendo la conversión directamente a int.
		System.out.println("El resultado del lanzamiento en centímetros es: " + longitud(int) );
